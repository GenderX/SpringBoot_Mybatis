...
<script type="text/javascript">
    ...
    function destroyUser() {
        ...
        if (row) {
            console.log(row);
            $.messager.confirm('确认', '是否删除员工?', function (r) {
                if (r) {
                    $.post('/staff/deleteStaff', {number: row.number}, function (result) {
                        if (result.success) {
    ...
    function editUser() {
        ...
        if (row) {
            ...
            $('#fm').form('load', row);
            url = '/staff/updateStaff?Number=' + row.number;
        }
    }
